...
export default function Loader() {
  ...
  useEffect(() => {
    if (reduced) return;
    // safeSession never throws — a raw sessionStorage.getItem() here threw in
    // storage-blocked browsers (mobile Brave Shields / private mode) and left
    // the site stuck on boot. Now it degrades to an in-memory flag instead.
